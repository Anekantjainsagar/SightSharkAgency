...
const SortByButton = ({ sort_by_options, loading }) => {
  ...
  return loading ? (
    ...
    >
      ...
      Sort By
      {showSortBy && (
        <div className="absolute right-0 top-[40px] border border-gray-50/10 md:top-[56px] rounded-lg md:rounded-lg w-[23vw] md:w-[12vw] bg-main z-50 small-scroller h-[10vh] md:h-fit overflow-y-auto">
