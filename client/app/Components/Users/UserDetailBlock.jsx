...
const UserDetailBlock = ({ data, loading }) => {
    ...
    <>
      ...
      {loading && userData?.first_name ? (
        <div className="py-4 px-4 md:px-7 border-gray-200/5 border-y grid userBlockGrid items-center cursor-pointer text-textGrey text-[13px] min-[1600px]:text-base">
          <div className="flex items-start min-[1600px]:ml-0 ml-2 animate-pulse">
            <div className="w-10 h-10 md:w-8 md:h-8 min-[1600px]:w-10 min-[1600px]:h-10 bg-gray-300 rounded-full"></div>
            <div className="ml-2.5 min-[1600px]:ml-4">
              <div className="w-24 h-4 bg-gray-300 rounded"></div>
              <div className="w-32 h-4 mt-2 bg-gray-300 rounded"></div>
            </div>
          </div>
          <div className="w-20 h-4 bg-gray-300 rounded mt-4 animate-pulse"></div>
          <div className="w-32 h-4 bg-gray-300 rounded mt-2 animate-pulse"></div>
          <div className="flex items-center justify-end mt-4">
            <div className="w-6 h-6 bg-gray-300 rounded-full mr-4 animate-pulse"></div>
