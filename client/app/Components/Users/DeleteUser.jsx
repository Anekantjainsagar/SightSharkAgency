    ...
    <div className="z-50">
      ...
      >
        <div className="bg-main relative rounded-lg">
          ...
          <div className="relative rounded-lg w-full h-full backdrop-blur-3xl py-4 md:py-6 border border-gray-500/40 px-3 md:px-4 text-white flex flex-col items-center justify-center">
            ...
            <h4 className="min-[1600px]:text-xl mt-5">
              Are you sure you want to delete the User?
            </h4>
            <p className="bg-[#171C2A]/40 p-3 text-[#ECECED] w-full text-center text-sm min-[1600px]:text-base my-2.5">
