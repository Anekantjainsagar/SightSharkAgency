            ...
            <div className="md:w-8/12 h-[66%] overflow-y-auto small-scroller md:h-fit justify-between flex flex-col items-start border border-gray-500/5 rounded-lg px-3 md:px-6 py-2 md:py-4 text-white">
              <div className="w-full">
                ...
                <div className="mt-3 md:mt-5">
                  <h6 className="text-sm md:text-base min-[1600px]:text-[20px] font-medium">
                    Change your password
                  </h6>{" "}
                  <div className="grid grid-cols-1 gap-y-4 md:gap-y-5 mt-4 w-full">
                    <div className="flex flex-col">
                      ...
                      <div className="w-full relative mt-1">
                        <input
                          ...
                          name="Password"
                          id="currentPass"
                          className="glass outline-none border border-gray-500/5 px-4 py-2 rounded-md w-full min-[1600px]:text-base text-[13px]"
                    ...
                    <div className="flex flex-col">
                      ...
                      {data?.newPassword && (
                        <div className="text-[13px] md:text-sm mt-2">
                          <p
                            className={
                ...
                <div className="h-[1px] w-full my-6 md:my-10 bg-gray-600/50"></div>{" "}
                <h4 className="text-sm md:text-base min-[1600px]:text-[20px] font-semibold">
                  Security preferences
                </h4>
                <p className="text-[#B2B4BA] min-[1600px]:text-base text-[12px] md:text-[13px] my-1">
                  Keep your account safe by setting these preferences
                </p>
                <div className="mt-5 flex items-center justify-between w-full">
                  <h6 className="text-[12px] md:text-[13px] min-[1600px]:text-base text-[#fff]">
              ...
              <div className="mt-10 flex items-center justify-end w-full">
                <button
                  className={`bg-[#898989]/15 font-semibold min-[1600px]:w-[160px] w-[120px] min-[1600px]:py-3 py-2 min-[1600px]:text-base text-[13px] rounded-xl ml-4`}
                  onClick={() => {
                    setData({
                      oldPass: "",
                      newPassword: "",
